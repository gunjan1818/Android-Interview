...
public class Simple extends Activity  implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        s_q = getResources().getStringArray(R.array.simple_ques);
        s_a = getResources().getStringArray(R.array.simple_ans);
